...
use App\Http\Controllers\ExtraContent\TypeInvoice;
use App\Http\Controllers\ExtraContent\TypeMeasure;
...
Route::get('/type-invoices', TypeInvoice::class);
Route::get('/type-measure', TypeMeasure::class);
